...
class CPJ_LinkCtrl : public ITcOCFCtrlImpl<CPJ_LinkCtrl, CPJ_LinkClassFactory>
{
public:
	CPJ_LinkCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("PJ_Link: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CPJ_LinkCtrl>;
